...
class FKimuraSourceControlChangelistState : public ISourceControlChangelistState
{
public:
	FKimuraSourceControlChangelistState(const FKimuraSourceControlChangelist& InChangelist);
	...
	/**
	 * The Kimura default changelist description cannot persist and must be set at submit.
	 */
...
public:
	FKimuraSourceControlChangelist	Changelist;
...
typedef TSharedRef<FKimuraSourceControlChangelistState, ESPMode::ThreadSafe> FKimuraSourceControlChangelistStateRef;
